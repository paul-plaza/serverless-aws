...
Execute unit tests
```
    cd "BgrDigitalServices.VerificacionDatos/test/BgrDigitalServices.VerificacionDatos.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "BgrDigitalServices.VerificacionDatos/src/BgrDigitalServices.VerificacionDatos"
